...
global $wpdb, $aptw_record_manager, $common_class;

$record_id      = isset($_GET['id']) ? $_GET['id'] : 0;
$record_section = isset($_GET['section']) ? $_GET['section'] : 0;
$record         = $aptw_record_manager->get_record_with_holders($record_id);
...
$common_class->update_seen_status($record_id, 'apt_women');
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="nav flex-column nav-pills" role="tablist">
                    <a href="<?= 'admin.php?page=ibr&tab=apt-women&section=basicdetails&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'basicdetails' ? 'active' : ''); ?>">Basic Details</a>
                    <a href="<?= 'admin.php?page=ibr&tab=apt-women&section=addressdetails&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'addressdetails' ? 'active' : ''); ?>">Address Details</a>
                    <a href="<?= 'admin.php?page=ibr&tab=apt-women&section=recorddetails&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'recorddetails' ? 'active' : ''); ?>">Award Details</a>
                    <a href="<?= 'admin.php?page=ibr&tab=apt-women&section=evidenceimages&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'evidenceimages' ? 'active' : ''); ?>">Evidance Images</a>
                    <a href="<?= 'admin.php?page=ibr&tab=apt-women&section=mediacoverageimages&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'mediacoverageimage' ? 'active' : ''); ?>">Media Coverage Images</a>
                    <a href="<?= 'admin.php?page=ibr&tab=apt-women&section=evidencevideos&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'evidencevideo' ? 'active' : ''); ?>">Evidance Videos</a>
                    <a href="<?= 'admin.php?page=ibr&tab=apt-women&section=bannerandfeatureimagevideos&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'bannerandfeatureimagevideo' ? 'active' : ''); ?>">Banner and Feature Image Videos</a>
                    <a href="<?= 'admin.php?page=ibr&tab=apt-women&section=concentform&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'concentform' ? 'active' : ''); ?>">Concent Form</a>
                    <a href="<?= 'admin.php?page=ibr&tab=apt-women&section=payment&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'payment' ? 'active' : ''); ?>">Payment Details</a>
                </div>
            </div>
            ...
            <div class="col-md-9">
                <div class="tab-content">
                    <form id="record-edit-form" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="action" value="edit_apt_women_section">
                        ...
                        <?php if ($record_section === 'recorddetails') { ?>
                            ...
                            <div class="tab-pane <?= ($record_section === 'recorddetails' ? 'active' : '') ?>" id="recorddetails">
                                ...
                                <div class="mb-3">
                                    ...
                                    <a href="<?= (! empty($record['slug'])) ? site_url() . '/apt-women/' . $record['slug'] : ''; ?>" target="_blank">URL&#8599;</a>
