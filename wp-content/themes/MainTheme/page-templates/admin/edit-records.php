...
global $wpdb, $world_record_manager, $common_class;

$record_id      = isset($_GET['id']) ? $_GET['id'] : 0;
$record_section = isset($_GET['section']) ? $_GET['section'] : 0;
$record         = $world_record_manager->get_record_with_holders($record_id);
...
$common_class->update_seen_status($record_id, 'records');
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="nav flex-column nav-pills" role="tablist">
                    <a href="<?= 'admin.php?page=wgt&tab=records&section=basicdetails&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'basicdetails' ? 'active' : ''); ?>">Basic Details</a>
                    <a href="<?= 'admin.php?page=wgt&tab=records&section=addressdetails&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'addressdetails' ? 'active' : ''); ?>">Address Details</a>
                    <a href="<?= 'admin.php?page=wgt&tab=records&section=recorddetails&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'recorddetails' ? 'active' : ''); ?>">Record Details</a>
                    <a href="<?= 'admin.php?page=wgt&tab=records&section=evidenceimages&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'evidenceimages' ? 'active' : ''); ?>">Evidance Images</a>
                    <a href="<?= 'admin.php?page=wgt&tab=records&section=mediacoverageimages&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'mediacoverageimage' ? 'active' : ''); ?>">Media Coverage Images</a>
                    <a href="<?= 'admin.php?page=wgt&tab=records&section=evidencevideos&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'evidencevideo' ? 'active' : ''); ?>">Evidance Videos</a>
                    <a href="<?= 'admin.php?page=wgt&tab=records&section=bannerandfeatureimagevideos&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'bannerandfeatureimagevideo' ? 'active' : ''); ?>">Banner and Feature Image Videos</a>
                    <a href="<?= 'admin.php?page=wgt&tab=records&section=concentform&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'concentform' ? 'active' : ''); ?>">Concent Form</a>
                    <a href="<?= 'admin.php?page=wgt&tab=records&section=payment&id=' . esc_attr($record_id); ?>" class="nav-link <?= ($record_section === 'payment' ? 'active' : ''); ?>">Payment Details</a>
                </div>
            </div>
            ...
            <div class="col-md-9">
                <div class="tab-content">
                    <form id="record-edit-form" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="action" value="edit_record_section">
                        ...
                        <div class="tab-pane <?= ($record_section === 'basicdetails' ? 'active' : '') ?>" id="basicdetails">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="applying_as" id="applying_as" class="form-select" required>
                                    ...
                                    <option value="2" <?= selected($cat->index, '2', false); ?> data-type="duo">Duo</option>
                                    <option value="3" <?= selected($cat->index, '3', false); ?> data-type="group">Group (3-99)</option>
                                    <option value="4" <?= selected($cat->index, '4', false); ?> data-type="mass">Mass (100+)</option>
                                    <option value="5" <?= selected($cat->index, '5', false); ?> data-type="commercial">Commercial</option>
                                </select>
                            </div>
                            <div class="mb-3" data-applying-as="solo duo group mass">
                                <label class="form-label">Record Holder Name</label>
                                <input class="form-control" type="text" name="holder_name" value="<?= esc_attr($holder1['name'] ?? ''); ?>">
                            </div>

                            <div class="mb-3" data-applying-as="duo">
                                <label class="form-label">Record Holder Name 2</label>
                                <input class="form-control" type="text" name="second_holder_name" value="<?= esc_attr($holder2['name'] ?? ''); ?>">
                            </div>

                            <div class="mb-3" data-applying-as="mass group">
                                <label class="form-label">Estimate No. of Participants</label>
                                <input class="form-control" type="text" name="estimate_participants" value="<?= esc_attr($record['estimate_participants'] ?? ''); ?>">
                            </div>

                            <div class="mb-3" data-applying-as="commercial">
                                <label class="form-label">Company Name</label>
                                <input class="form-control" type="text" name="company_name" value="<?= esc_attr($holder1['name'] ?? ''); ?>">
                            </div>
                            ...
                            <div class="mb-3" data-applying-as="solo">
                                <label class="form-label">Record Holder's Parent Name</label>
                        ...
                        <?php if ($record_section === 'recorddetails'): ?>
                            ...
                            <div class="tab-pane <?= ($record_section === 'recorddetails' ? 'active' : '') ?>" id="recorddetails">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="title" value="<?= (! empty($record['title'])) ? $record['title'] : ''; ?>">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Slug</label>
                                    <a href="<?= (! empty($record['slug'])) ? site_url() . '/records/' . $record['slug'] : ''; ?>" target="_blank">URL&#8599;</a>
                        ...
                        <?php if ($record_section === 'bannerandfeatureimagevideos'): ?>
                            <!-- Banner and Feature Image Videos -->
