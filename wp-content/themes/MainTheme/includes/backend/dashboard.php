...
function wgt_get_dashboard_stats()
{
    ...
    check_ajax_referer('wgt-nonce', 'security');
    ...
    <div class="stat-box"><h3>Super Talented Kids</h3><p class="stat-number">' . $stats['stk_records']['applied'] . '/' . $stats['stk_records']['approved'] . '</p></div>
    <div class="stat-box"><h3>Apt Women</h3><p class="stat-number">' . $stats['apt_women']['applied'] . '/' . $stats['apt_women']['approved'] . '</p></div>
    <div class="stat-box"><h3>Inspiring Humans</h3><p class="stat-number">' . $stats['ih_records']['applied'] . '/' . $stats['ih_records']['approved'] . '</p></div>
    ...
    <div class="stat-box"><h3>Super Talented Kids Revenue</h3><p class="stat-number">INR ' . round($stats['stk_records_revenue']) . '</p></div>
    <div class="stat-box"><h3>Apt Women Revenue</h3><p class="stat-number">INR ' . round($stats['apt_women_revenue'], 2) . '</p></div>
    <div class="stat-box"><h3>Inspiring Humans Revenue</h3><p class="stat-number">INR ' . round($stats['ih_records_revenue'], 2) . '</p></div>
