...
class Appreciation_List_Table extends WP_List_Table
{
    ...
    public function prepare_items()
    {
        ...
        if ($country) {
            ...
            $params[] = ibr_get_country_name_by_code($country);
        }
    ...
    public function column_default($item, $column_name)
    {
        ...
        switch ($column_name) {
            ...
            case 'action':
                $record_id = $item['id'];
                return '
                <a class="button button-primary" href="' . 'admin.php?page=ibr&tab=appreciation&section=basicdetails&id=' . esc_attr($record_id) . '">Edit</a<br>
                <a class="button button-primary" href="admin.php?page=ibr&tab=appreciation&action=participants&id=' . esc_attr($record_id) . '">Participants</>
            ';
