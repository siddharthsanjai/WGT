...
class WC_Email_Received_Email extends WC_Email
{

    public function __construct()
    {
        $this->id             = 'recived_email';
        $this->title          = __('Application Received Email', 'your-textdomain');
        $this->description    = __('This email is sent to users after form submission, customized for Membership & Application IDs.', 'your-textdomain');
        $this->template_html  = 'emails/received-email.php';
        $this->template_plain = 'emails/plain/received-email.php';
